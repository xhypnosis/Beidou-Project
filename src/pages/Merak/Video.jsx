                ...
                <Row className="h-[4750px]">
                    <Col span={8} className="text-center border-r border-black">
                        <div className="relative inline-block mt-8" onClick={() => screenPlay("#sem1", "#sem1Btn")}>
                            ...
                            <video id="sem1" preoload="none" controls width="406" poster={sem1} className=" h-[228px] relative">
                                <source src="https://video.wixstatic.com/video/6e6df2_d771b1fbdb524a69b0a273f77b50485a/1080p/mp4/file.mp4" type="video/mp4" />
                                Sorry, your browser doesn't support embedded videos.
                            </video>
                        </div>
                        <h2 className="inline-block mt-6 font-lato font-black text-[21px]">
                            Seminar1-开营仪式
                        </h2>
                        <br />
