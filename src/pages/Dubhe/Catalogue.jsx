        ...
        <div className="bg-space bg-cover">
            <div className="text-white">
                <Row className="pt-4">
                    <Col span={8}></Col>
                    <Col span={8}>
                        <h1 className="text-white mb-2 text-[40px] font-normal">
                            <span>日程安排</span>
                        </h1>
                        <span className="text-white text-[18px]">(课表根据实际情况可能进行调整)</span>
                    </Col>
                    <Col span={8}></Col>
                </Row>
                <Row className="mt-12 font-lato">
                    <Col span={3}></Col>
                    <Col span={8} clasName="ml-2">
                        <span className="inline-block text-lg">2020/9/21</span>
                        <span className="inline-block text-lg ml-8">Week 1</span>
                        <span className="inline-block text-lg my-3">Class Time：2020/9/26 & 2020/9/27 20:30 - 21:30</span>
                        <span className="font-metro font-bold inline-block text-[22px] my-3">Introduction & Token Economics</span>
                        <span className="inline-block text-[15px]">Introduction to Blockchain, Token Economics and DeFi DApp</span>
                    </Col>
                    <Col span={3}></Col>
                    <Col span={6}>
                ...
                <Row className="pt-24 pb-14 text-[15px]">
                    <Col span={5}></Col>
                    <Col span={14}>
                        <ul className="text-center list-disc list-inside tracking-normal">
                            <li className="pl-3 pb-1">全课程在线学习、中英双语教学。</li>
                            <li className="pl-3 pb-1">每周可预约一次office hour找老师答疑，助教在群内日常答疑。Gap week的设计是为了适应学生的期中考试安排，同时留给学生更多时间完成项目，在此期间没有线上课程，但成员依然可以预约答疑时间。</li>
                            <li className="pl-3">全部作业采用小组制，需合作完成，达到结业标准必须上传指定代码到Github且完成Presentation。</li>
                        </ul>
                    </Col>
                    <Col span={5}></Col>
                </Row>
