                ...
                <div className="h-24 text-left font-lato font-bold text-white text-[15px]">
                    ...
                    <Row className="ml-28 mr-40 mt-10 mb-36 leading-tight">
                        <Col span={5} className="text-center">
                            <a className="inline-block" href="https://conflux-edu.oss-cn-beijing.aliyuncs.com/%E5%A4%A9%E7%8E%912022/week%201/day3-web3%E5%9F%BA%E7%A1%80%E8%AE%BE%E6%96%BD-anyweb/%E8%AF%BE%E4%BB%B6/Lec2-1%262-2%20Web3%20%E5%85%A5%E5%8F%A3.pdf" target="_blank" rel="noreferrer">
                                <img className="w-[50px]" src={pdf} alt="" />
                            </a>
                            <br />
                            <span className="inline-block w-[140px] mt-8">Lec 2-1&2-2 Web3 入口</span>
                        </Col>
                        <Col span={5} className="text-center">
