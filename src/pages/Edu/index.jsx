...
export default function Edu() {
    return (
        <div className="h-auto bg-back bg-fixed bg-cover">
            <div className="h-[1800px] text-white">
                ...
                <div className="mt-20">
                    ...
                    <Row className="mt-20">
                        <Col span={3}></Col>
                        <Col span={9}>
                            <div className="w-80 relative text-center mx-auto mt-5">
                                <img className="inline-block" src={rect} alt="rectangle" />
                                <img className="absolute inline-block w-[213px] h-20 left-14 top-14" src={institution} alt="institution" />
                                <p className="absolute inline-block m-0 left-20 bottom-5 text-[15px]">上海科委下属研究机构</p>
                            </div>
                        </Col>
                        <Col span={1}></Col>
                        <Col span={11}>
                    ...
                    <Row className="mt-16">
                        ...
                        <Col span={9}>
                            <div className="w-80 relative text-center mx-auto  mt-5">
                                <img className="inline-block" src={rect} alt="rectangle" />
                                <img className="absolute inline-block w-[213px] h-12 left-14 top-14" src={logo} alt="logo" />
                                <p className="absolute inline-block w-[234px] m-0 left-12 bottom-5 text-[15px] leading-tight">世界级明星公链，清华姚班团队，获红杉、百度风投Fundamental Labs等多家资本投资。</p>
                            </div>
                        </Col>
                        <Col span={1}></Col>
                        <Col span={11}>
